...
# Two monitors active
if len(settings) == 2:
  command = "xrandr --output DisplayPort-1 --primary --rate " + toggled + " --mode 1920x1080 --pos 0x0 --rotate normal --output HDMI-A-1 --mode 1920x1080 --pos 1920x630 --rotate normal"
else:
  command = "xrandr --output DisplayPort-1 --primary --rate " + toggled + " --mode 1920x1080 --pos 0x0 --rotate normal"
